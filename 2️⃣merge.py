...
# 請根據您上傳的檔案名稱，修改下方的變數。
aes_file_path = "/content/drive/MyDrive/國科會超大數據/sp80022_segmented_dataset (1).csv"      # <--- 包含 2500 筆 AES 數據的檔名
rc4_file_1_path = "/content/drive/MyDrive/國科會超大數據/sp80022_segmented_dataset (2).csv"  # <--- 第一份 500 筆 RC4 的檔名
rc4_file_2_path = "/content/drive/MyDrive/國科會超大數據/sp80022_segmented_dataset (3).csv"  # <--- 第二份 500 筆 RC4 的檔名

# 設定最終輸出的檔名與路徑
output_file_path = DRIVE_FOLDER_PATH + "dataset_aes_rc4_1000_each.csv"
#  ▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲▲
# ==============================================================================
...
# --- 步驟 2: 檢查檔案是否存在 ---
print("\n--- 步驟 2: 檢查檔案是否存在 ---")
file_paths = [aes_file_path, rc4_file_1_path, rc4_file_2_path]
...
print("正在從 AES 數據中隨機抽樣 1000 筆...")
aes_sample_df = aes_df.sample(n=1000, random_state=42)
...
print(f"兩份 RC4 數據維度分別為: {rc4_df1.shape} 和 {rc4_df2.shape}")

# 將兩份 RC4 數據合併
print("正在合併兩份 RC4 數據...")
rc4_combined_df = pd.concat([rc4_df1, rc4_df2], ignore_index=True)
