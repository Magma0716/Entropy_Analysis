...
if __name__ == '__main__':
    ...
    class HistoryObject:
        ...
        '''
        df_history = pd.read_csv(f'/home/a0919/Entropy_Analysis/data/{file_name}/train_history.csv') # <<<<< 替換這裡
        history = df_history.to_dict(orient='list')

    history = HistoryObject()
    
    # 2. 定義您的目標測試列表
    results_df = pd.read_csv(f'/home/a0919/Entropy_Analysis/data/{file_name}/r2_results.csv')
    ...
    Y_test = np.load(f'/home/a0919/Entropy_Analysis/data/{file_name}/y_test.npy') # <<<<< 替換這裡
    ...
    '''
    Y_pred = np.load(f'/home/a0919/Entropy_Analysis/data/{file_name}/y_pred.npy') # <<<<< 替換這裡
